...
function fetchAndDisplayCars(db, filters = {}) {
    db.collection("cars").where("BidStatus", "==", "Ended").get()
        .then(querySnapshot => {
            const cars = [];
...
function renderCars(cars) {
    ...
    cars.forEach(car => {
        const carDetailUrl = `endedBidPage.html?vin=${encodeURIComponent(car.VIN)}`;
        ...
        let carHTML = `
            <div class="col-12 col-md-6">
                <div class="car" data-href="${carDetailUrl}">
                    ...
                    <ul class="car__list">
                        ...
                        <li><img src="../assets/icons/calendar.svg" alt="End date"><span id="end-date-${car.VIN}">Data încheierii: ${car.End_date}</span></li>
                        <li><img src="../assets/icons/timer.svg" alt="Time left"><span>Licitație finalizată</span></li>
                    </ul>
                    <div class="car__footer">
                        <div class="car__offer">
                            <span class="car__offer-text">Vândută la prețul de:</span>
        ...
        // Add click event to the entire car element
        const carElement = container.lastElementChild.querySelector('.car');
